...
- [x] QP02 Exécuter chaque scénario et vérifier les critères de succès programmatiquement
  Depends on: QP01
...
- [x] QP03 Générer un rapport croisé tokens économisés vs taux de succès
...
- [x] QP04 Ajouter `just bench-quality` qui exécute QP02 + QP03
